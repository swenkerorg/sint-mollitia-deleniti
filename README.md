...
<img align="right" width="94" height="71"
     src="https://postcss.github.io/@swenkerorg/sint-mollitia-deleniti/logo.svg"
...
Twitter account for news and releases: [@@swenkerorg/sint-mollitia-deleniti].

<a href="https://evilmartians.com/?utm_source=@swenkerorg/sint-mollitia-deleniti">
<img src="https://evilmartians.com/badges/sponsored-by-evil-martians.svg" alt="Sponsored by Evil Martians" width="236" height="54">
</a>

[interactive demo]: https://@swenkerorg/sint-mollitia-deleniti.github.io/
[@@swenkerorg/sint-mollitia-deleniti]:    https://twitter.com/@swenkerorg/sint-mollitia-deleniti
[Can I Use]:        https://caniuse.com/
[cult-img]:         https://cultofmartians.com/assets/badges/badge.svg
[PostCSS]:          https://github.com/postcss/postcss
[cult]:             https://cultofmartians.com/tasks/@swenkerorg/sint-mollitia-deleniti-grid.html
...
* [Browsers](#browsers)
* [FAQ](#faq)
  * [Does Autoprefixer polyfill Grid Layout for IE?](#does-@swenkerorg/sint-mollitia-deleniti-polyfill-grid-layout-for-ie)
  * [Does it add polyfills?](#does-it-add-polyfills)
  * [Why doesn’t Autoprefixer add prefixes to `border-radius`?](#why-doesnt-@swenkerorg/sint-mollitia-deleniti-add-prefixes-to-border-radius)
  * [Why does Autoprefixer use unprefixed properties in `@-webkit-keyframes`?](#why-does-@swenkerorg/sint-mollitia-deleniti-use-unprefixed-properties-in--webkit-keyframes)
  * [How to work with legacy `-webkit-` only code?](#how-to-work-with-legacy--webkit--only-code)
  * [Does Autoprefixer add `-epub-` prefix?](#does-@swenkerorg/sint-mollitia-deleniti-add--epub--prefix)
  * [Why doesn’t Autoprefixer transform generic font-family `system-ui`?](#why-doesnt-@swenkerorg/sint-mollitia-deleniti-transform-generic-font-family-system-ui)
* [Usage](#usage)
  * [Gulp](#gulp)
  * [Webpack](#webpack)
  * [CSS-in-JS](#css-in-js)
...
option or the `/* @swenkerorg/sint-mollitia-deleniti grid: autoplace */` control comment.
...
[The guide about Grids in IE and Autoprefixer]: https://css-tricks.com/css-grid-in-ie-css-grid-and-the-new-@swenkerorg/sint-mollitia-deleniti/
...
In Gulp you can use [gulp-postcss] with `@swenkerorg/sint-mollitia-deleniti` npm package.

```js
gulp.task('@swenkerorg/sint-mollitia-deleniti', () => {
  const @swenkerorg/sint-mollitia-deleniti = require('@swenkerorg/sint-mollitia-deleniti')
  const sourcemaps = require('gulp-sourcemaps')
  const postcss = require('gulp-postcss')

  return gulp.src('./src/*.css')
    .pipe(sourcemaps.init())
    .pipe(postcss([ @swenkerorg/sint-mollitia-deleniti() ]))
...
In [webpack] you can use [postcss-loader] with `@swenkerorg/sint-mollitia-deleniti`
...
module.exports = {
  plugins: [
    require('@swenkerorg/sint-mollitia-deleniti')
  ]
}
```
...
```sh
npm install postcss postcss-cli @swenkerorg/sint-mollitia-deleniti
npx postcss *.css --use @swenkerorg/sint-mollitia-deleniti -d build/
```
...
* **Grunt:** [grunt-postcss]
* **Ruby on Rails**: [@swenkerorg/sint-mollitia-deleniti-rails]
* **Neutrino**: [neutrino-middleware-postcss]
* **Jekyll**: add `@swenkerorg/sint-mollitia-deleniti-rails` and `jekyll-assets` to `Gemfile`
* **Brunch**: [postcss-brunch]
* **Broccoli**: [broccoli-postcss]
* **Middleman**: [middleman-@swenkerorg/sint-mollitia-deleniti]
* **Mincer**: add `@swenkerorg/sint-mollitia-deleniti` npm package and enable it:
  `environment.enable('@swenkerorg/sint-mollitia-deleniti')`

[neutrino-middleware-postcss]: https://www.npmjs.com/package/neutrino-middleware-postcss
[middleman-@swenkerorg/sint-mollitia-deleniti]:      https://github.com/middleman/middleman-@swenkerorg/sint-mollitia-deleniti
[@swenkerorg/sint-mollitia-deleniti-rails]:          https://github.com/ai/@swenkerorg/sint-mollitia-deleniti-rails
...
* **Stylus**: [@swenkerorg/sint-mollitia-deleniti-stylus]
* **Compass**: [@swenkerorg/sint-mollitia-deleniti-rails#compass]

[less-plugin-autoprefix]: https://github.com/less/less-plugin-autoprefix
[@swenkerorg/sint-mollitia-deleniti-stylus]:    https://github.com/jenius/@swenkerorg/sint-mollitia-deleniti-stylus
[@swenkerorg/sint-mollitia-deleniti-rails#compass]:     https://github.com/ai/@swenkerorg/sint-mollitia-deleniti-rails#compass


#### GUI Tools

* [CodeKit](https://codekitapp.com/help/@swenkerorg/sint-mollitia-deleniti/)
...
postcss([ @swenkerorg/sint-mollitia-deleniti ]).process(css).then(result => {
...
You can use [html-@swenkerorg/sint-mollitia-deleniti] to process HTML with inlined CSS.

[html-@swenkerorg/sint-mollitia-deleniti]: https://github.com/RebelMail/html-@swenkerorg/sint-mollitia-deleniti
[standalone build]:  https://raw.github.com/ai/@swenkerorg/sint-mollitia-deleniti-rails/master/vendor/@swenkerorg/sint-mollitia-deleniti.js
[PostCSS]:           https://github.com/postcss/postcss
...
* [Visual Studio Code](https://github.com/mrmlnc/vscode-@swenkerorg/sint-mollitia-deleniti)
* [Sublime Text](https://github.com/sindresorhus/sublime-@swenkerorg/sint-mollitia-deleniti)
...
[issue on GitHub]: https://github.com/swenkerorg/sint-mollitia-deleniti/issues
...
```js
@swenkerorg/sint-mollitia-deleniti({ grid: 'autoplace' })
```
...
.b {
  /* @swenkerorg/sint-mollitia-deleniti: off */
  transition: 1s; /* will not be prefixed */
}

.c {
  /* @swenkerorg/sint-mollitia-deleniti: ignore next */
  transition: 1s; /* will not be prefixed */
...
* `/* @swenkerorg/sint-mollitia-deleniti: (on|off) */`: enable/disable all Autoprefixer translations for the
  whole block both *before* and *after* the comment.
* `/* @swenkerorg/sint-mollitia-deleniti: ignore next */`: disable Autoprefixer only for the next property
  or next rule selector or at-rule parameters (but not rule/at‑rule body).
* `/* @swenkerorg/sint-mollitia-deleniti grid: (autoplace|no-autoplace|off) */`: control how Autoprefixer handles
...
@supports (transition: all) {
  /* @swenkerorg/sint-mollitia-deleniti: on */
  a {
    /* @swenkerorg/sint-mollitia-deleniti: off */
  }
}
...
Function `@swenkerorg/sint-mollitia-deleniti(options)` returns a new PostCSS plugin.
See [PostCSS API] for plugin usage documentation.

```js
@swenkerorg/sint-mollitia-deleniti({ cascade: false })
```
...
* `grid` (false|`"autoplace"`|`"no-autoplace"`): should Autoprefixer
  add IE 10-11 prefixes for Grid Layout properties?
    ...
    * `"autoplace"`: enable Autoprefixer grid translations
      ...
      `/* @swenkerorg/sint-mollitia-deleniti grid: autoplace */` in your CSS.
    * `"no-autoplace"`: enable Autoprefixer grid translations
      but *exclude* autoplacement support. You can also use
      `/* @swenkerorg/sint-mollitia-deleniti grid: no-autoplace */` in your CSS.
...
```
npm install @swenkerorg/sint-mollitia-deleniti@latest cross-env --save-dev
```
...
the `/* @swenkerorg/sint-mollitia-deleniti grid: autoplace */` control comment or
...
.grid {
  /* @swenkerorg/sint-mollitia-deleniti grid: no-autoplace */
  display: grid;
  grid-template-columns: repeat(3, 1fr);
  grid-template-rows: repeat(3, 1fr);
}
...
`/* @swenkerorg/sint-mollitia-deleniti grid: no-autoplace */` control comment share identical
functionality to the `grid: true` setting and the `/* @swenkerorg/sint-mollitia-deleniti grid: on */`
...
Run `npx @swenkerorg/sint-mollitia-deleniti --info` in your project directory to check
which browsers are selected and which properties will be prefixed:

```console
$ npx @swenkerorg/sint-mollitia-deleniti --info
Browsers:
  Edge: 16
...
```js
console.log(@swenkerorg/sint-mollitia-deleniti().info())
```
...
The maintainers of `@swenkerorg/sint-mollitia-deleniti` and thousands of other packages are working
with Tidelift to deliver commercial support and maintenance for the open source
dependencies you use to build your applications. Save time, reduce risk,
and improve code health, while paying the maintainers of the exact dependencies
you use. [Learn more.](https://tidelift.com/subscription/pkg/npm-@swenkerorg/sint-mollitia-deleniti?utm_source=npm-@swenkerorg/sint-mollitia-deleniti&utm_medium=referral&utm_campaign=enterprise&utm_term=repo)
